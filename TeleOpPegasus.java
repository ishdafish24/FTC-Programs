...
public class TeleOpPegasus extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // Controls for intake wheels
            intakeOffset = Range.clip(intakeOffset, -1, 1);
            if (gamepad2.dpad_down)
            {
                for (double i = 0.2; i < 1; i = i +0.01) {


                    intakeOffset += INTAKE_SPEED;
                    robot.lIntake.setPosition(i);
                             //robot.rIntake.setPosition(robot.neutral + intakeOffset);
                    }
            }
            ...
            {
                intakeOffset += INTAKE_SPEED;
                robot.lIntake.setPosition(robot.neutral + intakeOffset);
            }
